...
#wenzt
    VF_IF = 'OVEHOSTED_NETWORK/vfNic'
    VF_NM = 'OVEHOSTED_NETWORK/vfNums'
    MGMT_NIC_IF = 'OVEHOSTED_NETWORK/nicMgmtNet'
    MGMT_IPADDR = 'OVEHOSTED_NETWORK/ipaddrMgmt'
    MGMT_NETMASK = 'OVEHOSTED_NETWORK/netMaskMgmt'
    MGMT_GATEWAY = 'OVEHOSTED_NETWORK/gatewayMgmt'
    CEPH_NIC_IF = 'OVEHOSTED_NETWORK/nicCEPH'
    CEPH_PUBLIC_IPADDR = 'OVEHOSTED_NETWORK/ipaddrCEPH'
    CEPH_PUBLIC_NETMASK = 'OVEHOSTED_NETWORK/netMaskCEPH'
    CEPH_PUBLIC_GATEWAY = 'OVEHOSTED_NETWORK/gatewayCEPH'
...
#wenzt
    ENABLE_ETHVF = 'ohosted.host.eth.vf.enabled'
    MGMT_CFG = 'ohosted.host.eth.mgmt.config'
    CEPH_PUBLIC_CFG = 'ohosted.host.eth.ceph.config'
#wenzt
